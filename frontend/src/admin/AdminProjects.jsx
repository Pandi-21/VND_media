            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="flex-1">
                ...
                <label
                  ...
                  className="inline-flex cursor-pointer rounded-xl border border-white/10 bg-[#0a0a0a] px-5 py-3.5 text-xs font-bold tracking-wider hover:border-[#0BB80F]/40 transition-all text-white"
                >
                  SELECT FILE
                </label>
...
export default function AdminProjects() {
  ...
  const handleModalSave = (savedProject) => {
    setShowModal(false);
    fetchProjects(); // Reload list to respect sorting
  };
    ...
    <div className="p-8 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-black italic mt-2 text-white">PROJECTS (WORK)</h1>
        </div>
        <button
          onClick={handleAdd}
